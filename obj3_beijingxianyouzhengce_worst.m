function [final_result,final_result2,final_result3] = obj3_worst_sce1()
%% 参数设置
%引入二者的距离,矩阵大小为m*n+1,单位为km
% D = xlsread('D:\桌面\氢能重卡\爬虫\网格化\matlab优化代码\1距离计算\距离及需求结果.xlsx',...
%     'B2:KL321');
...
% sub_max_large=400;%大型加氢站的一次性补贴金额
% C = [];
% %% 各单目标最优值确定
% for i = 1:len
%     D = D_list(:,:,i);
