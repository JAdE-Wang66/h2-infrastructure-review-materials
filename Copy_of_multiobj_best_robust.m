function [final_result,final_result2,final_result3,need] = Copy_of_multiobj_best_robust()
...
Xvqiu_xiaoqu_list = Xvqiu_xiaoqu_list * 1.05; %最差场景
...
% min_obj1 = 212958.5819;
% max_obj1 = 584175.2776;
% min_obj2 = 27284.59464;
% max_obj2 = 509036.3203;
% min_obj3 = 63561.3328;
% max_obj3 = 198566.7603;
...
ops.cplex.mip.tolerances.mipgap = 0.05;
...
save('Copy_of_multiobj_best_robust_all')
end
