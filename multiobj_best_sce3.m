function [final_result,final_result2,final_result3] = multiobj_best_sce3()
...
min_obj1 =109154.9954;
max_obj1 =1247688.544;
min_obj2 =19503.73754;
max_obj2 = 600107.8673;
...
% sub_max_mid=[300;250;200;150;100;50;0;0];%中型加氢站的补贴上限
% sub_rate_large=0.3;%大型加氢站的补贴比例
% sub_max_large=[500;450;400;350;300;250;200;150];%大型加氢站的补贴上限
% subsidy=zeros(n,1);
% sub_mid_tem=0;
% C = [];
% %% 各单目标最优值确定
